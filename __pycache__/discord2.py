...
async def on_message(message):
    if message.author == client.user:
        ...
        if commands[0] == '$stream':
            while True :
                await client.delete_message(message)
                await client.change_presence(game=discord.Game(name='logan', url="https://www.twitch.tv/shroud", type=1))
                await asyncio.sleep(10)
                await client.change_presence(game=discord.Game(name='gang', url="https://www.twitch.tv/shroud", type=1))
                await asyncio.sleep(10)
                await client.change_presence(game=discord.Game(name='mag', url="https://www.twitch.tv/shroud", type=1))
                await asyncio.sleep(10)
                await client.change_presence(game=discord.Game(name='god', url="https://www.twitch.tv/shroud", type=1))
        if commands[0] == '$nick':
        ...
        if commands[0] == '$cycle':
            while True :
                await client.change_nickname(message.author, "l ")
                await asyncio.sleep(.1)
                await client.change_nickname(message.author, "lo")
                await asyncio.sleep(.1)
                await client.change_nickname(message.author, "log")
                await asyncio.sleep(.1)
                await client.change_nickname(message.author, "logan")
        if commands[0] == '$cl':
            if len(commands) == 1:
...
client.run('MzM5NzQ3MTA1NTYyMTY1MjQ4.DhzT9g.ZQkrymtIr16LuX_RhrNF0_MFXRw', bot=False)
